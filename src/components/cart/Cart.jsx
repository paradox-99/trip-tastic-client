...
const Cart = ({ spot }) => {
    ...
    return (
        <div className='relative font-montserrat'>
            <img src={photo_url} alt="" className='h-[550px]' />
            <div className='absolute w-full h-[400px] bottom-0 bg-cartImage'>
                <div className='relative w-full h-[400px]'>
                    ...
                    <Link to={`/view-details/${_id}`} className='bg-white text-black px-4 py-2 rounded-md absolute right-3 bottom-2'>Details</Link>
                </div>
            </div>
        </div>
    );
