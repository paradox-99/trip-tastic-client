...
const Footer = () => {
    return (
        <div className="mt-20">
            <footer className="footer px-28 py-10 bg-[#020202] text-white">
                ...
                <form>
                    ...
                    <fieldset className="form-control w-80">
                        ...
                        <div className="join">
                            <input type="text" placeholder="username@gamil.com" className="input input-bordered join-item font-nunito" />
                            <button className="btn btn-primary join-item font-montserrat">Submit</button>
                        </div>
                    </fieldset>
                </form>
            </footer>
            <footer className="footer px-28 py-6 border-t bg-[#020202] text-white border-base-300">
